...
var ntc = {
  ...
  nameFromHSL: function (h, s, l) {
    var color = this.colorFromHSL(h, s, l);
    return this.name(color);
  },

  colorFromHSL: function (h, s, l) {
    s = s / 100;
    l = l / 100;
    var rgb = this.hslToRgb(h, s, l);
    var r = this.toHex(Math.round(rgb.r));
    var g = this.toHex(Math.round(rgb.g));
    var b = this.toHex(Math.round(rgb.b));
    var color = "#" + r + g + b;
    return color;
  },
